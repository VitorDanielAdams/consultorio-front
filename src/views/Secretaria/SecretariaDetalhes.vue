<template>
    <h1 class="title is-4 has-text-left">Detalhe Secretaria</h1>
    <form>
        <div class="columns p-5">
            ...
            <div class="column is-5">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="number" placeholder="Insira o salario">
                    </div>
                </div>
            </div>
        </div>
        <div class="column is-10 is-flex is-justify-content-space-between p-5">
            ...
            <div class="field">
                <div class="control">
                    <input class="button has-background-primary has-text-white is-uppercase btn" value="Desativar">
                </div>
            </div>
        </div>
    </form>
...
<script lang="ts">
    ...
    export default class SecretariaDetalhe extends Vue {
